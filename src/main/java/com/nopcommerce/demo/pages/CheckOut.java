...
By verify2ndDayAir = By.xpath("//span[normalize-space()='2nd Day Air']");
    ...
    public void basicFormFillUp(){
        ...
        doubleClickAndSendKeysOnElement(inputCityName,"Bangalore");
        doubleClickAndSendKeysOnElement(inputAddressLineOne,"231, Red Square Building");
        doubleClickAndSendKeysOnElement(inputAddressLineTwo,"Nr. Old PostOffice");
